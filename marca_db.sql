...
CREATE TABLE TARJETA (
    ...
    PAIS_TARJETA VARCHAR(3) NOT NULL,
...
CREATE TABLE COMISION (
    ...
    PREFIJO_MARCA VARCHAR(6) NOT NULL,
...
(3, 'Banco Emisor 3', 'PER');

INSERT INTO CLIENTE (COD_CLIENTE, NOMBRE, APELLIDO, DIRECCION_LINEA1, DIRECCION_LINEA2, TELEFONO, CORREO) VALUES
(10, 'Juan', 'Pérez', 'Av. Principal 123', 'Edificio Central', '0987654321', 'juan.perez@example.com'),
(20, 'Ana', 'Gómez', 'Calle Secundaria 456', 'Conjunto Jardines', '0998765432', 'ana.gomez@example.com'),
(30, 'Dario', 'Ruales', 'Cucardas y Congonas', 'Queens NY', '0999235691', 'dario.ruales@example.com'),
(40, 'Andres', 'Rosero', 'Issac Albeniz y Coral', 'Ica ', '+591981100075', 'andres.rosero@example.com');
...
INSERT INTO TARJETA (COD_TARJETA, COD_BANCO_EMISOR, COD_CLIENTE, NUMERO_TARJETA, NOMBRE_EN_TARJETA, CVV_TARJETA, PAIS_TARJETA, FECHA_EXPIRACION, TIPO_TARJETA, ESTADO_TARJETA) VALUES
(701, 1, 10, '5181723524186399', 'JUAN PEREZ', '291', 'ECU', '2029-02-01', 'DEB', 'ACTIVA'),
(702, 1, 20, '4548209353078965', 'ANA MARIA GOMEZ D', '491', 'ECU', '2028-05-01', 'CRE', 'ACTIVA'),
(703, 2, 30, '4050852368353293', 'DARIO RUALES', '837', 'USA', '2028-06-01', 'CRE', 'ACTIVA'),
(704, 3, 40, '4548206233707219', 'ANDRES ROSERO', '101', 'PER', '2026-06-01', 'CRE', 'ACTIVA');
...
(100, 701, 1, 1, '2025-01-01', 100.50, 'APR', 1, 'AUTH123', 'COMPRA', 'USD', 'ECU', 'OK', 5.00, 'WEB'),
(200, 702, 2, 2, '2025-01-02', 200.75, 'REC', 2, 'AUTH456', 'RETIRO', 'USD', 'USA', 'FONDOS INSUFICIENTES', 10.00, 'POS');
...
(6001, 'VISA', '4', 'CREDITO', 'ECU', 0.018, 0.015, 'PORCENTAJE', 0.1, 'ACTIVO', '2024-01-01', 'comision de ecu para visa tarjeta de credito'),
(5002, 'VISA', '4', 'DEBITO', 'ECU', 0.03, 0.02, 'PORCENTAJE', 0.15, 'ACTIVO', '2024-01-01', ''),
(5003, 'VISA', '4', 'LIQUIDACION', 'ECU', 20, 10, 'FIJO', 0, 'ACTIVO', '2024-01-01', ''),
(5004, 'VISA', '4', 'CREDITO', 'PER', 0.017, 0.014, 'PORCENTAJE', 0.08, 'ACTIVO', '2024-01-01', ''),
(5005, 'VISA', '4', 'DEBITO', 'PER', 0.028, 0.018, 'PORCENTAJE', 0.12, 'ACTIVO', '2024-01-01', ''),
(5006, 'VISA', '4', 'LIQUIDACION', 'PER', 20, 10, 'FIJO', 0, 'ACTIVO', '2024-01-01', ''),
(5007, 'VISA', '4', 'CREDITO', 'USA', 0.03, 0.02, 'PORCENTAJE', 0.25, 'ACTIVO', '2024-01-01', ''),
(5008, 'VISA', '4', 'DEBITO', 'USA', 0.03, 0.025, 'PORCENTAJE', 0.3, 'ACTIVO', '2024-01-01', ''),
(5009, 'VISA', '4', 'LIQUIDACION', 'USA', 20, 10, 'FIJO', 0, 'ACTIVO', '2024-01-01', ''),
(5010, 'MASTERCARD', '5', 'CREDITO', 'ECU', 0.018, 0.015, 'PORCENTAJE', 0.1, 'ACTIVO', '2024-01-01', ''),
(5011, 'MASTERCARD', '5', 'DEBITO', 'ECU', 0.03, 0.02, 'PORCENTAJE', 0.15, 'ACTIVO', '2024-01-01', ''),
(5012, 'MASTERCARD', '5', 'CREDITO', 'PER', 0.017, 0.014, 'PORCENTAJE', 0.08, 'ACTIVO', '2024-01-01', ''),
(5013, 'MASTERCARD', '5', 'DEBITO', 'PER', 0.028, 0.018, 'PORCENTAJE', 0.12, 'ACTIVO', '2024-01-01', ''),
(5014, 'MASTERCARD', '5', 'CREDITO', 'USA', 0.03, 0.02, 'PORCENTAJE', 0.25, 'ACTIVO', '2024-01-01', ''),
(5015, 'MASTERCARD', '5', 'DEBITO', 'USA', 0.03, 0.025, 'PORCENTAJE', 0.3, 'ACTIVO', '2024-01-01', ''),
(5016, 'AMERICAN EXPRESS', '3', 'CREDITO', 'USA', 2.5, 3, 'FIJO', 0, 'ACTIVO', '2024-01-01', ''),
(5017, 'UNION PAY', '6', 'CREDITO', 'USA', 0.015, 0.02, 'FIJO', 0, 'ACTIVO', '2024-01-01', '')
;
